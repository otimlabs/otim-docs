...
For this example, let's say you're Netflix :movie_camera: and you want to support `USDC` subscription payments. Let's walk through how you could integrate Otim to support crypto subscriptions.
...
- set `Instruction.interval` to one month in seconds
