...
For this example let's say you're terrible with remembering birthdays :grimacing: so you want to set up automatic on-chain reminders. Let's write a smart contract that will emit an event to remind you:
